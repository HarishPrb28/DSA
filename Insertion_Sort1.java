...
Since this is a learning exercise, it will not be the most efficient way of performing the insertion. It will instead demonstrate the brute-force method in detail.
...
Input Format The first line contains the integer n, the size of the array arr .
